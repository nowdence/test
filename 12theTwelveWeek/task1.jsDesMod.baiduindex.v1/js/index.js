...
define(function(require, exports, module) {
    ...
    a.selectMyfocus = function() {
        $("#myfocus").mouseover(function() {
            ...
            $(".s-contents").load("fragments/addmyfocus.htm", function(a, b, c) {
                if (status == "error") {
                    $("body").text("加载失败");
                }
            });
    ...
    a.selectNews = function() {
        $("#news").mouseover(function() {
            ...
            $(".s-contents").load("fragments/addnews.htm", function(a, b, c) {
                if (status == "error") {
                    $("body").text("加载失败");
                }
            });
    ...
    a.selectNav = function() {
        $("#nav").mouseover(function() {
            ...
            $(".s-contents").load("fragments/addnav.htm", function(a, b, c) {
                if (status == "error") {
                    $("body").text("加载失败");
                }
            });
    ...
    a.selectMovies = function() {
        $("#movies").mouseover(function() {
            ...
            $(".s-contents").load("fragments/addmovies.htm", function(a, b, c) {
                if (status == "error") {
                    $("body").text("加载失败");
                }
            });
    ...
    a.selectShopping = function() {
        $("#shopping").mouseover(function() {
            ...
            $(".s-contents").load("fragments/add.htm", function(a, b, c) {
                if (status == "error") {
                    $("body").text("加载失败");
                }
            });
    ...
    a.seeMore = function() {
        $(".s-morebar").mouseover(function() {
            $(".s-morebar").load("fragments/addmore.htm", function(a, b, c) {
                if (status == "error") {
                    $("body").text("加载失败");
                }
            });
