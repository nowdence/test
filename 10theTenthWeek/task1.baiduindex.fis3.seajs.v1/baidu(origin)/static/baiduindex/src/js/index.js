...
define(function(require, exports, module) {
  ...
  a.selectMyfocus = function() {
    $("#myfocus").mouseover(function() {
      ...
      $(".s-contents").load("./static/baiduindex/src/fragments/addmyfocus.htm", function(a, b, c) {
        // console.log(a);
        // console.log(b);
        // console.log(c);
        if (status == "error") {
  ...
  a.selectNews = function() {
    $("#news").mouseover(function() {
      ...
      $(".s-contents").load("./static/baiduindex/src/fragments/addnews.htm", function(a, b, c) {
        // console.log(a);
        // console.log(b);
        // console.log(c);
        if (status == "error") {
  ...
  a.selectNav = function() {
    $("#nav").mouseover(function() {
      ...
      $(".s-contents").load("./static/baiduindex/src/fragments/addnav.htm", function(a, b, c) {
        // console.log(a);
        // console.log(b);
        // console.log(c);
        if (status == "error") {
  ...
  a.selectMovies = function() {
    $("#movies").mouseover(function() {
      ...
      $(".s-contents").load("./static/baiduindex/src/fragments/addmovies.htm", function(a, b, c) {
        // console.log(a);
        // console.log(b);
        // console.log(c);
        if (status == "error") {
  ...
  a.selectShopping = function() {
    $("#shopping").mouseover(function() {
      ...
      $(".s-contents").load("./static/baiduindex/src/fragments/add.htm", function(a, b, c) {
        // console.log(a);
        // console.log(b);
        // console.log(c);
        if (status == "error") {
  ...
  a.seeMore = function() {
    $(".s-morebar").mouseover(function() {
      $(".s-morebar").load("./static/baiduindex/src/fragments/addmore.htm", function(a, b, c) {
        // console.log(a);
        // console.log(b);
        // console.log(c);
        if (status == "error") {
